...
<nav class="navbar">
    ...
    <li id="<?php echo $item['id'];?>"><a href="<?php echo $item['link'];?>" data-underline="<?php echo $item['underline-id'];?>" onmousedown="mouseDown('<?php echo $item['underline-id'];?>')" onmouseup="setTimeout(mouseUp, 1000)" onmouseover="removeId()" onmouseout="setId()"><?php echo $item['name'];?></a></li>
    <?php } ?>
